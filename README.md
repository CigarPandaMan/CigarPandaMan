...
<picture>
  ...
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/CigarPandaMan/CigarPandaMan/output/github-snake.svg" />
  <img alt="Snake animation" src="https://raw.githubusercontent.com/CigarPandaMan/CigarPandaMan/output/github-snake.svg" />
</picture>
...
```
```
⚖️  Attorney who got tired of reading contracts manually
🤖  So I taught machines to do it instead
🐼  Part panda, part smoke, 100% billable
💻  My code has fewer bugs than my legal briefs have typos
📜  Licensed to practice law. Chose to practice Python.
🔥  Currently automating myself out of a job
```
